...
- [Done] Fork and clone this repository. **If you are repeating this Course, delete your old fork from Github and re-fork and re-clone.**
- [Done] Create a new branch: `git checkout -b <firstName-lastName>`.
- [Done] Implement the project on your newly created branch, committing changes regularly.
- [Done] Push commits: `git push origin <firstName-lastName>`.
- [Done] **RUN** `npm install` to install your dependencies.

### Task 2: CodeGrade Setup

- [Done] Follow [instructions](https://www.notion.so/lambdaschool/Submitting-an-assignment-via-Code-Grade-A-Step-by-Step-Walkthrough-07bd65f5f8364e709ecb5064735ce374) to set up Codegrade's Webhook and Deploy Key, making sure your deployment is set to your `<firstName-lastName>` branch.
...
- [Done] Write an _npm script_ named _"start"_ that uses `node` to run the API server.
- [Done] Write an _npm script_ named _"server"_ that uses `nodemon`to run the API server.
- [Done] Install _nodemon_ as a development dependency only that would not be used in production.

#### Build an API

- [Done] Inside `api/actions/actions-router.js` build endpoints for performing CRUD operations on _actions_:
...
- [Done] Inside `api/projects/projects-router.js` build endpoints for performing CRUD operations on _projects_:
...
- [Done] Inside `api/projects/projects-router.js` add an endpoint for retrieving the list of actions for a project:
